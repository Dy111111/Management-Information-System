...
namespace 党建信息管理系统LS.DataClassLS
{
    class MeansLS
    {
        #region  全局变量
        ...
        public static string M_str_sqlcon = "Data Source=(local);Initial Catalog=党建信息数据库;Integrated Security=True";//"Data Source=DESKTOP-G91MKHP\\MSSQLSERVER1;Initial Catalog=党建信息数据库;Integrated Security=True";
        ...
        public static string AllSql = "Select * from PMBasic";    //存储党员基本信息表中的SQL语句
